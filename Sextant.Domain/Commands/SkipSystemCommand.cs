...
{
    public class SkipSystemCommand : ICommand
    {
        private readonly INavigator _navigator;
        private readonly ICommunicator _communicator;
        private readonly IPlayerStatus _playerStatus;
        private readonly PhraseBook _systemScanned;
        private readonly PhraseBook _notExpeditionSystem;
        private readonly string _errorPhrase;

        public string SupportedCommand => "skip_system";
        public bool Handles(IEvent @event) => @event.Event == SupportedCommand;

        public SkipSystemCommand(ICommunicator communicator, INavigator navigator, IPlayerStatus playerStatus, SkipSystemPhrases phrases, ScansRemainingPhrases scanPhrases)
        {
            ...
            _systemScanned       = PhraseBook.Ingest(phrases.SystemScanned);
        ...
        public void Handle(IEvent @event)
        {
            ...
            bool success  = _navigator.ScanSystem(currentSystem);
            string script = success ? _systemScanned.GetRandomPhrase() : _errorPhrase;
